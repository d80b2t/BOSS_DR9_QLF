...
;  if gamma_2[ii] lt beta_min then print, 'ii, gamma_2, beta_min', ii, gamma_2[ii], beta_min
...
;      position=[.08+xposoff, .60, .32+xposoff, .98], $
      position=[.40+xposoff,  .60, .40+.24+xposoff, .98], $ ;; top, middle planel of 3
...
;      position=[.40+xposoff, .60, .40+.24+xposoff, .98], $
      position=[.715+xposoff, .60, .72+.245+xposoff, .98], $ ;; top right panel
...
;;
;: normalisation,   T O P    R I G H T... 
;;
plot, z_HRH07, log_phi_norm_HRH, $
;      position=[.72+xposoff, .60, .72+.24+xposoff, .98], $
      position=[.72+xposoff, .12, .72+.24+xposoff, .50], $
...
readcol, '/cos_pc19a_npr/BOSS/QLF/pro/models/HRH07/HRH07_Bband_z2.00.dat', $ 
         Lum_B_band, AB_mag, mono_flux, Lbol, num_den

w_zslice = where(z_HRH07 ge 2.00 and z_HRH07 lt 2.10, N_zslice)

;plot, Mstar_HRH07[w_zslice], log_phi_norm_HRH[w_zslice], $
plot, Mstar_PLE_PD, log_phi_norm_HRH[w_zslice], $
      position=[0.08,  .38, .32, .76], $
      xrange=[-20, -30], yrange=[-10.0,-5.0], $
      /nodata, $
      xtitle='!6 M!13*!6, Absolute Magnitude', $
      ytitle='!6 log(!7u!6!15*!6!N)', $
      xstyle=1, ystyle=1, xthick=xthick, ythick=ythick, $
      XTICKLEN=XTICKLEN, YTICKLEN=YTICKLEN, $
      charsize=charsize, charthick=charthick,  thick=thick
;oplot, Mstar_HRH07[w_zslice], log_phi_norm_HRH[w_zslice], thick=linethick, color=black
oplot,  AB_mag, alog10(num_den)-1.5, thick=linethick, color=black
...
legend, pos=[xpos,            ypos-0.6], ' ',      box=0, thick=12, linestyle = 0, charsize=1.2, color=black
xyouts,      xpos+(1.6*xoff), ypos+(-0.4*yoff), 'Hopkins, Richards ', charsize=charsize_lab, charthick=charthick_lab
xyouts,      xpos+(1.6*xoff), ypos+(0.8*yoff), '& Hernquist (2007)', charsize=charsize_lab, charthick=charthick_lab
...
if plot_qlf_points eq 'y' then begin
   ...
   xyouts,      xpos+(1.2*xoff),  ypos+(0.9*yoff), 'Palanque et al. (2013)', charsize=charsize_lab*1.1, charthick=charthick_lab*1.2, color=blue
   
   ypos = -22.0
   legend, pos=[xpos,             ypos], ' ',      box=0, thick=12, linestyle = 0, charsize=1.2, color=turquiose
   xyouts,      xpos+(1.2*xoff),  ypos+(0.9*yoff), 'Ross et al. (2013)', charsize=charsize_lab*1.25, charthick=charthick_lab*1.2, color=turquiose
   
   ypos = -20.0
   legend, pos=[xpos,             ypos], ' ',      box=0, thick=12, linestyle = 0, charsize=1.2, color=red
   xyouts,      xpos+(1.2*xoff),  ypos+(0.9*yoff), 'McGreer et al. (2013)', charsize=charsize_lab*1.2, charthick=charthick_lab*1.2, color=red
endif
