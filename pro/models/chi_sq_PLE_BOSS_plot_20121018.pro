...
;;
;;   M O D E L     M c G R E E R    ``L E D E''    z = 2.20 - 3.50
;; 
    alpha_test =  -1.40
     beta_test =  -3.57
 Mstar0_g_test = -26.78
...
;LEDE $\Phi^*$ & 2.2--3.5 &  $-1.40^{+0.15}_{-0.01}$ &  $-3.57^{+0.07}_{-0.24}$ &  $-26.78^{+0.27}_{-0.13}$ &  $-0.606^{+0.021}_{-0.012}$ &  $-0.505^{+0.015}_{-0.248}$ &  $-6.08^{+0.44}_{-0.15}$ &   137/113 

;LEDE $\Phi^*$ & 2.2--3.5 &  $-1.38^{+0.15}_{-0.01}$ &  $-3.57^{+0.07}_{-0.24}$ &  $-26.74^{+0.27}_{-0.13}$ &  $-0.606^{+0.021}_{-0.012}$ &  $-0.505^{+0.015}_{-0.248}$ &  $-6.05^{+0.44}_{-0.15}$ &   137/113 
