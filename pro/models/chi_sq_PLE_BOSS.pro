...
;readcol, '../../pro/qlf/QLF_iband_sdss_boss_narrow_boss21_wSelfn_formatted_McGkcor.dat', $
...
;w_zbin = where(z_full ge 0.68 and Z_full le 2.20, N)
...
if coarse_or_fine eq 1 then begin
   Phi_star_norm = -6.40
   phi_step      =  0.00040 ;; 0.016  ; ((-6.0) - (-5.6))/25.
