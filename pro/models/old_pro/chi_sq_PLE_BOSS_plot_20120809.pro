...
;;   M O D E L     A
;; 
;; My best-fit over 0.20 < z < 2.20 with "coarse binning...
;;  w_zbin = where(z_full ge 0.20 and Z_full le 2.20, N)
...
dmag_test      = Mg_test - Mstar_g_test
ple_denom_test = (10.0^(0.4*(alpha_test+1)*(dmag_test))) + (10.0^(0.4*(beta_test+1)*(dmag_test))) 
phi_fit_c   = Phi_star_test /ple_denom_test

Mstar_g_test   = Mstar0_g_test  - 2.5*(k1_test*z_range + k2_test*z_range*z_range)
dmag_test      = M_range_full - Mstar_g_test
ple_denom_test = (10.0^(0.4*(alpha_test+1)*(dmag_test))) + (10.0^(0.4*(beta_test+1)*(dmag_test))) 
phi_fit_c_full = Phi_star_test /ple_denom_test
...
dmag_test      = Mg_test - Mstar_g_test
ple_denom_test = (10.0^(0.4*(alpha_test+1)*(dmag_test))) + (10.0^(0.4*(beta_test+1)*(dmag_test))) 
phi_fit_d   = Phi_star_test /ple_denom_test

Mstar_g_test   = Mstar0_g_test  - 2.5*sqrt(k1_test*z_range)
dmag_test      = M_range_full - Mstar_g_test
ple_denom_test = (10.0^(0.4*(alpha_test+1)*(dmag_test))) + (10.0^(0.4*(beta_test+1)*(dmag_test))) 
phi_fit_d_full = Phi_star_test /ple_denom_test
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=0 
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_c_full[300:449]), thick=line_thick/2., color=light_blue,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_d[w_plot]), thick=line_thick, color=orange, linestyle=1 
oplot, M_range, alog10(phi_fit_d_full[300:449]), thick=line_thick/2., color=orange,linestyle=0
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_c_full[450:599]), thick=line_thick/2., color=light_blue,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_d[w_plot]), thick=line_thick, color=orange, linestyle=1 
oplot, M_range, alog10(phi_fit_d_full[450:599]), thick=line_thick/2., color=orange,linestyle=0
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_b[w_plot]), thick=line_thick, color=purple, linestyle=0 
oplot, M_range, alog10(phi_fit_a_full[600:749]), thick=line_thick/2., color=purple,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_a_full[600:749]), thick=line_thick/2., color=light_blue,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_d[w_plot]), thick=line_thick, color=orange, linestyle=1 
oplot, M_range, alog10(phi_fit_d_full[600:749]), thick=line_thick/2., color=orange,linestyle=0
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_a[w_plot]), thick=line_thick, color=black,  linestyle=0
oplot, M_range, alog10(phi_fit_a_full[750:849]), thick=line_thick/2., color=black,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_b[w_plot]), thick=line_thick, color=purple, linestyle=0 
oplot, M_range, alog10(phi_fit_b_full[750:849]), thick=line_thick/2., color=black,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_c_full[750:849]), thick=line_thick/2., color=black,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_d[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_d_full[750:849]), thick=line_thick/2., color=black,linestyle=0
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_c_full[1200:1349]), thick=line_thick/2., color=light_blue,linestyle=0
...
oplot, MG_2SLAQ[w_plot], alog10(phi_fit_b[w_plot]), thick=line_thick, color=purple, linestyle=0 
oplot, M_range, alog10(phi_fit_b_full[1500:1649]), thick=line_thick/2., color=black,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_c[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_c_full[1500:1649]), thick=line_thick/2., color=light_blue,linestyle=0

oplot, MG_2SLAQ[w_plot], alog10(phi_fit_d[w_plot]), thick=line_thick, color=light_blue, linestyle=1 
oplot, M_range, alog10(phi_fit_d_full[1500:1649]), thick=line_thick/2., color=black,linestyle=0
...
legend, ' ' , $
        ...
        charsize=charsize/1.4, thick=20.
legend, ' ' , $
        position=[xpos, ypos+(7.*ypos_off)], box=0, linestyle=6, color=yellow, $
        charsize=charsize/1.4, thick=20.
legend, ' ' , $
