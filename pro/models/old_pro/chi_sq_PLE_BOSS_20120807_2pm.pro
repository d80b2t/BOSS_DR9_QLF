...
w_zbin = where(z_full ge 2.20 and Z_full le 3.60, N)
...
oplot, MG_2SLAQ[w_plot], alog10(phi_best_fit[w_plot]), thick=3, color=200
...
;w_plot = where(z_full  ge z_bin_range_min and Z_full  le z_bin_range_max, N)

plotsym, 0, 1.6, /fill
plot, MG_2SLAQ[w_plot] , LOG_PHI_2SLAQ[w_plot], $
;plot, MI_MEAN_FULL[w_plot] , LOG_PHI_full[w_plot], $
