...
if readin eq 'n' then begin
   ...
   readcol, '../../data/2SLAQ_QSO_mini.cat', $
            ra_2SLAQ, dec_2SLAQ, $
            umag_2SLAQ, gmag_2SLAQ, rmag_2SLAQ, imag_2SLAQ, zmag_2SLAQ, $
            z_2SLAQ 
   ...
   ;;
   ;; We either want:
   ;; all the BOSS Stripe 82 data, without any completeness
   ;; corrections, or the "XDCORE-SPALL" file. 
   ;; 
...
for ii = 0L, 10 do begin 
   ...
   for jj = 0L, 37 do begin 
      ...
      ;; FOR BOSS QSOs
      ;;
      if N_QSOs_boss le 0 then printf, 14, z_bin, Abs_mag_bin, -9999.999, -999.,     N_QSOs_boss
      if N_QSOs_boss gt 0 then begin
         mean_z  = mean(boss[w_qlfbin_boss].z)
       ...
       ;  if N_selfn ne 0 then print, ii,jj, z_bin, Abs_mag_bin, Num_den_sum, log_Num_den_sum_boss, N_QSOs_boss, N_selfn, selfn[w_selfn]
         ...
         printf, 14, z_bin, Abs_mag_bin, Num_den_sum,     log_Num_den_sum_boss,     N_QSOs_boss
