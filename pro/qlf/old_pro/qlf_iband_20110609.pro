...
;   target_flag = 16492675464192LL  
   ...
   boss_qsos_full = where( ((data.boss_target1 and target_flag) ne 0) $
                           and data.zWarning eq 0 and $
                           data.z ge 0.02 and data.z lt 6.10, N_boss_qsos_full)
   ...
   ;; This is fine. 
   ;; We just want to include as many potential 
   ;; QSOs (without a prejudice on the redshift) that have decent
   ;; spectra
   N_boss_qsos_wDups = 0
   ...
   data = mrdfits('../../../bossqsomask/trunk/data/compfiles/xdspall.fits',1)
...
;   completeness_level = 0.75
   ...
   w_boss = where(data.poly_weight ge completeness_level and $
                  data.zWarning eq 0 and data.z ge 0.02, N)
   ...
   print
   print
   print, ' N_boss_qsos_full  ', N_boss_qsos_full
   print, ' N_boss_qsos_hiz   ', N_boss_qsos_hiz
   print, ' N_boss_qsos_wDups ', N_boss_qsos_wDups
   print
...
;readcol, '../../completeness/old_models/modelA_i_sel.txt', i_start, i_end, z_start, z_end, selfn
;readcol, '../../completeness/old_models/modelA_i_sel_PQSOMIDZ.txt', i_start, i_end, z_start, z_end, selfn
readcol, '../../completeness/sims_200QSO_5000LOS_modelA/modelA_200QSO_5000LOS_iPQSOMIDZ_sel.txt', i_start, i_end, z_start, z_end, selfn
print
...
;dlums_zphot = DLUMINOSITY(zphot)  / 1e6
   dlums_comp   = DLUMINOSITY(z_comp)  / 1e6 ;; from Richards06...The sign convention of the K-correction, K(z), is defined by Oke & Sandage (1968) as mintrinsic 1⁄4 mobserved 􏰈 K(z).
...
;;
;Area_boss50 = 3327.1504 /41253.
;Area_boss75 = 2623.98 /41253.
Area_boss95 = 1437.25/41253.

Area_Stp82 =  (220.0/41253.)
Area_dr3   =  (1622./41253.)
;; From Richards06 (p.4) ``The uncertainty on this area is of order 10 deg^2''
...
;         endfor
      ...
      ;; FOR BOSS QSOs
      ;;
      if N_QSOs_boss le 0 then printf, 12, z_bin, Abs_mag_bin, -9999.999, -999.,     N_QSOs_boss
