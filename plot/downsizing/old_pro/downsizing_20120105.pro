...
read, choice_plot_boss21, PROMPT=' - Plot boss21  points?? y/n  '
...
if choice_plot_R06 eq 'y' then begin
   ...
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*1.), errcolor=black+(cstep*1.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*1.), errcolor=black+(cstep*1.)

   w = where( Mi_z2 ge binranges[5] and Mi_z2 lt binranges[6], N)
   oplot, Z_R06[w], LOG_PHIR06[w],  psym=8, color=black+(cstep*2.) 
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*2.), errcolor=black+(cstep*2.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*2.), errcolor=black+(cstep*2.)

   w = where( Mi_z2 ge binranges[7] and Mi_z2 lt binranges[8], N)
   oplot, Z_R06[w], LOG_PHIR06[w], psym=8, color=black+(cstep*3.)
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*3.), errcolor=black+(cstep*3.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*3.), errcolor=black+(cstep*3.)

   w = where( Mi_z2 ge binranges[9] and Mi_z2 lt binranges[10], N)
   oplot, Z_R06[w], LOG_PHIR06[w],  psym=8, color=black+(cstep*4.)
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*4.), errcolor=black+(cstep*4.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*4.), errcolor=black+(cstep*4.)

   w = where( Mi_z2 ge binranges[11] and Mi_z2 lt binranges[12], N)
   oplot, Z_R06[w], LOG_PHIR06[w], psym=8, color=black+(cstep*5.)
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*5.), errcolor=black+(cstep*5.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*5.), errcolor=black+(cstep*5.)

   w = where( Mi_z2 ge binranges[13] and Mi_z2 lt binranges[14], N)
   oplot, Z_R06[w], LOG_PHIR06[w],  psym=8, color=black+(cstep*6.)
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*6.), errcolor=black+(cstep*6.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*6.), errcolor=black+(cstep*6.)

   w = where( Mi_z2 ge binranges[15] and Mi_z2 lt binranges[16], N)
   oplot, Z_R06[w], LOG_PHIR06[w], psym=8, color=black+(cstep*7.)
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*7.), errcolor=black+(cstep*7.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*7.), errcolor=black+(cstep*7.)

   w = where( Mi_z2 ge binranges[17] and Mi_z2 lt binranges[18], N)
   oplot, Z_R06[w], LOG_PHIR06[w],  psym=8, color=black+(cstep*8.)
   Z_R06_err = Z_R06[w] - Z_R06[w]
   oploterror, Z_R06[w], log_PHIR06[w], z_R06_err, R06_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*8.), errcolor=black+(cstep*8.)
   oploterror, Z_R06[w], log_PhiR06[w], z_R06_err, R06_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*8.), errcolor=black+(cstep*8.)
...
if choice_plot_boss eq 'y' then begin
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w],  psym=8, color=black+(cstep*1) 
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*1), errcolor=black+(cstep*1)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*1), errcolor=black+(cstep*1)
   if choice_boss_line eq 'y' then oplot, Z_boss[w], LOG_PHI_boss[w], thick=thick, color=black+(cstep*1)

   w = where( Mi_z2_boss ge binranges[5] and Mi_z2_boss lt binranges[6] and  Z_boss ge 2.10, N)
   oplot, Z_boss[w], LOG_PHI_boss[w], psym=8, color=black+(cstep*2)
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*2), errcolor=black+(cstep*2)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w],  psym=8, color=black+(cstep*3)
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*3), errcolor=black+(cstep*3)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w], psym=8, color=black+(cstep*4)
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*4), errcolor=black+(cstep*4)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w],  psym=8, color=black+(cstep*5)
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*5), errcolor=black+(cstep*5)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w], psym=8, color=black+(cstep*6)
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*6), errcolor=black+(cstep*6)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w],  psym=8, color=black+(cstep*7)   
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*7), errcolor=black+(cstep*7)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
   ...
   oplot, Z_boss[w], LOG_PHI_boss[w],  psym=8, color=black+(cstep*8)  
   Z_boss_err = Z_boss[w] - Z_boss[w]
   oploterror, Z_boss[w], LOG_PHI_boss[w], z_boss_err, boss_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*8), errcolor=black+(cstep*8)
   oploterror, Z_boss[w], log_Phi_boss[w], z_boss_err, boss_delta_down[w], $
...
;;   w = where( Mi_z2_boss21 ge binranges[15]  and Mi_z2_boss21 lt binranges[16] and Z_boss21 ge 0.68 and z_boss21 lt 2.2 , N)
   ;oplot, Z_boss21[w], LOG_PHI_boss21[w], psym=8, color=black+(cstep*7)
  ; Z_boss21_err = Z_boss21[w] - Z_boss21[w]
   ...
   w = where( Mi_z2_boss21 ge binranges[17]  and Mi_z2_boss21 lt binranges[18] and Z_boss21 ge 0.68 and z_boss21 lt 2.2 , N)
   oplot, Z_boss21[w], LOG_PHI_boss21[w], psym=8, color=black+(cstep*8)
   Z_boss21_err = Z_boss21[w] - Z_boss21[w]
   oploterror, Z_boss21[w], LOG_PHI_boss21[w], z_boss21_err, boss21_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*8), errcolor=black+(cstep*8)
   oploterror, Z_boss21[w], log_Phi_boss21[w], z_boss21_err, boss21_delta_down[w], $
   ...
   w = where( Mi_z2_boss21 ge binranges[19]  and Mi_z2_boss21 lt binranges[20] and Z_boss21 ge 0.68 and z_boss21 lt 2.2, N)
   oplot, Z_boss21[w], LOG_PHI_boss21[w], psym=8, color=black+(cstep*9)
   Z_boss21_err = Z_boss21[w] - Z_boss21[w]
   oploterror, Z_boss21[w], LOG_PHI_boss21[w], z_boss21_err, boss21_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*9), errcolor=black+(cstep*9)
   oploterror, Z_boss21[w], log_Phi_boss21[w], z_boss21_err, boss21_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*9), errcolor=black+(cstep*9)
   
   w = where( Mi_z2_boss21 ge binranges[21]  and Mi_z2_boss21 lt binranges[22] and Z_boss21 ge 0.68 and z_boss21 lt 2.2, N)
   oplot, Z_boss21[w], LOG_PHI_boss21[w], psym=8, color=black+(cstep*10)
   Z_boss21_err = Z_boss21[w] - Z_boss21[w]
   oploterror, Z_boss21[w], LOG_PHI_boss21[w], z_boss21_err, boss21_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*10), errcolor=black+(cstep*10)
   oploterror, Z_boss21[w], log_Phi_boss21[w], z_boss21_err, boss21_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*10), errcolor=black+(cstep*10)
   
   w = where( Mi_z2_boss21 ge binranges[23]  and Mi_z2_boss21 lt binranges[24] and Z_boss21 ge 0.68 and z_boss21 lt 2.2, N)
   oplot, Z_boss21[w], LOG_PHI_boss21[w], psym=8, color=black+(cstep*11)
   Z_boss21_err = Z_boss21[w] - Z_boss21[w]
   oploterror, Z_boss21[w], LOG_PHI_boss21[w], z_boss21_err, boss21_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*11), errcolor=black+(cstep*11)
   oploterror, Z_boss21[w], log_Phi_boss21[w], z_boss21_err, boss21_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*11), errcolor=black+(cstep*11)

   w = where( Mi_z2_boss21 ge binranges[25]  and Z_boss21 ge 0.68 and z_boss21 lt 2.2, N)
   oplot, Z_boss21[w], LOG_PHI_boss21[w], psym=8, color=black+(cstep*12)
   Z_boss21_err = Z_boss21[w] - Z_boss21[w]
   oploterror, Z_boss21[w], LOG_PHI_boss21[w], z_boss21_err, boss21_delta_up[w], $
               /hibar, errthick=12, psym=8, color=black+(cstep*12), errcolor=black+(cstep*12)
   oploterror, Z_boss21[w], log_Phi_boss21[w], z_boss21_err, boss21_delta_down[w], $
               /lobar, errthick=12, psym=8, color=black+(cstep*12), errcolor=black+(cstep*12)
...
if choice_plot_LDDE eq 'y' then begin
   ...
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*1) 
   w = where(mag_LDDE gt binranges[5] and mag_LDDE lt binranges[6], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*2)
   w = where(mag_LDDE gt binranges[7] and mag_LDDE lt binranges[8], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*3)
   w = where(mag_LDDE gt binranges[9] and mag_LDDE lt binranges[10], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*4)
   w = where(mag_LDDE gt binranges[11] and mag_LDDE lt binranges[12], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*5)
   w = where(mag_LDDE gt binranges[13] and mag_LDDE lt binranges[14], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*6)
   w = where(mag_LDDE gt binranges[15] and mag_LDDE lt binranges[16], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*7)
   w = where(mag_LDDE gt binranges[17] and mag_LDDE lt binranges[18], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*8)
;; for boss21
   w = where(mag_LDDE gt binranges[19] and mag_LDDE lt binranges[20], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*9)
   w = where(mag_LDDE gt binranges[21] and mag_LDDE lt binranges[22], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*10)
   w = where(mag_LDDE gt binranges[23] and mag_LDDE lt binranges[24], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*11)
   w = where(mag_LDDE gt binranges[25] and mag_LDDE lt binranges[26], N)
   oplot, Z_LDDE[w], LOG_PHI_LDDE[w], thick=thick, linestyle=1, color=black+(cstep*12)
endif
...
xyouts, xmax*0.74, -9.7, '-29.50',  charsize=charsize, charthick=charthick, color=black
xyouts, xmax*0.74, -9.3, '-28.75',  charsize=charsize, charthick=charthick, color=black+(cstep*1)
xyouts, xmax*0.74, -8.9, '-28.25',  charsize=charsize, charthick=charthick, color=black+(cstep*2)
xyouts, xmax*0.74, -8.5, '-27.50',  charsize=charsize, charthick=charthick, color=black+(cstep*3)
xyouts, xmax*0.74, -8.1, '-27.00',  charsize=charsize, charthick=charthick, color=black+(cstep*4)
xyouts, xmax*0.74, -7.7, '-26.50',  charsize=charsize, charthick=charthick, color=black+(cstep*5)
xyouts, xmax*0.74, -7.3, '-25.75',  charsize=charsize, charthick=charthick, color=black+(cstep*6)
xyouts, xmax*0.74, -6.9, '-25.25',  charsize=charsize, charthick=charthick, color=black+(cstep*7)
xyouts, xmax*0.74, -6.5, '-24.50',  charsize=charsize, charthick=charthick, color=black+(cstep*8)
xyouts, xmax*0.74, -6.1, '-24.00',  charsize=charsize, charthick=charthick, color=black+(cstep*9)
xyouts, xmax*0.74, -5.7, '-23.50',  charsize=charsize, charthick=charthick, color=black+(cstep*10)
xyouts, xmax*0.74, -5.3, '-22.75',  charsize=charsize, charthick=charthick, color=black+(cstep*11)
xyouts, xmax*0.74, -5.3, '-22.25',  charsize=charsize, charthick=charthick, color=black+(cstep*12)
