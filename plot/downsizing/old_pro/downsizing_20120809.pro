...
if N ge 5 then begin
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*0), thick=thick
   print, N, mean(Mi_bin_full[w]), 0.5*(binranges[3] +binranges[2] )
endif

w = where(Mi_bin_full le binranges[4] and Mi_bin_full gt binranges[3], N)
if N ge 5 then begin
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*1), thick=thick
...
if N ge 5 then begin
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*2), thick=thick
   print, N, mean(Mi_bin_full[w])
endif

w = where(Mi_bin_full le binranges[6] and Mi_bin_full gt binranges[5], N)
if N ge 5 then begin
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*3), thick=thick
   print, N, mean(Mi_bin_full[w])
endif

w = where(Mi_bin_full le binranges[7] and Mi_bin_full gt binranges[6], N)
if N ge 5 then begin
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*4), thick=thick
   print, N, mean(Mi_bin_full[w])
endif

w = where(Mi_bin_full le binranges[8] and Mi_bin_full gt binranges[7], N)
if N ge 5 then begin 
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*5), thick=thick
   print, N, mean(Mi_bin_full[w])
endif

w = where(Mi_bin_full le binranges[9] and Mi_bin_full gt binranges[8], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*6), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[10] and Mi_bin_full gt binranges[9], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*7), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[11] and Mi_bin_full gt binranges[10], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*8), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[12] and Mi_bin_full gt binranges[11], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*9), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[13] and Mi_bin_full gt binranges[12], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*10), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[14] and Mi_bin_full gt binranges[13], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*11), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[15] and Mi_bin_full gt binranges[14], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*12), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[16] and Mi_bin_full gt binranges[15], N)
if N ge 5 then oplot, z_full[w], log_phi_full[w], color=black+(clr_step*13), thick=thick
print, N, mean(Mi_bin_full[w])

w = where(Mi_bin_full le binranges[17] and Mi_bin_full gt binranges[16], N)
;; N = 5
if N ge 5 then begin
   oplot, z_full[w], log_phi_full[w], color=black+(clr_step*14), thick=thick
   print, N, mean(Mi_bin_full[w])
endif
