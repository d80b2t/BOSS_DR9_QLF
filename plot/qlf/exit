...
if (choice_models eq 'y') then begin
   ...
   readcol, '../../pro/models/CW12_qsolf_z2.40.dat', $
...
if choice_models eq 'y' then begin
    ...
    w_CW12 = where(z_LEDE   gt 2.35 and z_LEDE  lt 2.45, N_LEDE)
    ...
    per_mag = alog10(2.5)
    if (choice_models_HRH07 eq 'y') then begin
       oplot, Mi_HRH07, alog10(phi_HRH07_z2pnt4)-per_mag, thick=8, linestyle=0, color=turquiose ;;red
    endif
