...
readcol, '../../pro/qlf/My_QLF/My_QLF_iband_boss_narrowZ_S82_20120807.dat', $  ;; Us
...
;readcol, '../../pro/qlf/My_QLF/My_QLF_iband_boss_wgt_fiducial_grid.dat', $
readcol, '../../pro/qlf/My_QLF_iband_boss_wgt_fiducial_grid_rv1.dat', $
         z_bin_boss_bin2, Mi_boss_bin2, blah_boss_bin2, log_Phi_BOSS_bin2, raw_N_boss_QSOs_bin2

;readcol, '../../pro/qlf/My_QLF/My_QLF_iband_boss_wgt_expdust.dat', $ 
readcol, '../../pro/qlf/My_QLF_iband_boss_wgt_expdust_rv1.dat', $ 
...
;readcol, '../../pro/qlf/My_QLF_narrowZ/My_QLF_iband_boss_narrowZ_wgt_fiducial_grid.dat', $
readcol, '../../pro/qlf/My_QLF_iband_boss_narrowZ_wgt_fiducial_grid_rv1.dat', $
...
;readcol, '../../pro/qlf/My_QLF_narrowZ/My_QLF_iband_boss_narrowZ_wgt_expdust.dat', $
readcol, '../../pro/qlf/My_QLF_iband_boss_narrowZ_wgt_expdust_rv1.dat', $
...
;; xy_outs 
x_xyouts = -25.90        ;; -26.20   ;; could also be e.g. -24.70, 
y_xyouts = -0.44
...
!p.multi=[0,3,3]
set_plot, 'ps'
;device, filename='QLF_iband_R06_z2_narrowZ_selfunc_divfid_temp.ps',$ 
  ;; old filenames...
device, filename='QLF_selfunc_divfid_noS82_McGkcor_rv1_temp.ps', $
...
;       ytitle='log!I10!N (!7U!3!Icalc!N!3/!7U!3!Ifiducial!N!3)'
...
if (choice_DR9_points eq 'y') then begin
   ...
   divmodel = 10^(log_Phi_boss[www])

   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82 gt 2.20 and z_bin_boss_S82 lt 2.30 and $
                   Mi_boss_S82 le max(Mi_boss[www]) and Mi_boss_S82 ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]

      ratio     =  alog10((10^log_Phi_boss_S82[w82]) /divmodel)
      diff_up   =  ratio - alog10((10^(log_Phi_boss_S82[w82] + boss_delta_up_S82[w82])) / divmodel)
      diff_down =  ratio - alog10((10^(log_Phi_boss_S82[w82] + boss_delta_down_S82[w82])) / divmodel)
      
      oploterror, Mi_boss_S82[w82], ratio, Mi_boss_err_S82, diff_up,  $
                  /hibar, errthick=12, psym=8, color=color_S82, ERRcolor=color_S82
      oploterror, Mi_boss_S82[w82], ratio, Mi_boss_err_S82, diff_down, $   
                  /lobar, errthick=12, psym=8, color=color_S82, errcolor=color_S82
   endif
   

   plotsym, plot_sym_fid, plot_sym_size_DR9, /fill
   oplot, Mi_boss[www], alog10((10^log_Phi_boss_fid[www])/divmodel), psym=3, color=color_dr9_fid, thick=12
   plotsym, plot_sym_exp, plot_sym_size_DR9, /fill
   oplot, Mi_boss[www], alog10((10^log_Phi_boss_exp[www])/divmodel), psym=3, color=color_dr9_exp, thick=12
   ...
   oploterror, Mi_boss[www], ratio, Mi_boss_err, diff_up, $
               /hibar, errthick=12, psym=3, color=color_dr9, ERRcolor=color_dr9
   oploterror, Mi_boss[www], ratio, Mi_boss_err, diff_down, $
               /lobar, errthick=12, psym=3, color=color_dr9, errcolor=color_dr9
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 2.30 and z_bin_boss_S82  lt 2.40 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 2.40 and z_bin_boss_S82  lt 2.50 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 2.50 and z_bin_boss_S82  lt 2.60 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 2.60 and z_bin_boss_S82  lt 2.70 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 2.70 and z_bin_boss_S82  lt 2.80 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 2.80 and z_bin_boss_S82  lt 3.00 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
;;
charthick_lab = charthick*1.4
charsize_lab  = charsize/1.8
loadct, 0

xpos = -24.15
ypos =  -0.54     ;; -0.42 for the bottom-right corner ;; 0.740 for the middle right
y_off = 0.16
...
plotsym, 0, 1.3, /fill
legend, 'fiducial' , $
        position=[xpos, ypos+(3*y_off)], box=0, psym=8, color=color_dr9, $
        charsize=charsize_lab, charthick =charthick_lab

plotsym, plot_sym_exp, 1.3, /fill
legend, 'exp dust' , $
        position=[xpos, ypos+(2*y_off)], box=0, psym=8, color=color_dr9_exp, $
           charsize=charsize_lab, charthick =charthick_lab

plotsym, plot_sym_fid, 1.3, /fill
legend, 'VdB lines' , $
        position=[xpos, ypos+(y_off)], box=0, psym=8, color=color_dr9_fid, $
           charsize=charsize_lab, charthick =charthick_lab

if (choice_S82_points eq 'y') then begin
   loadct, 6
   plotsym, 0, 1.5, /fill
   legend, 'BOSS S82 QSOs' , $
           position=[xpos, ypos], box=0, psym=8, color=color_S82, $
           charsize=charsize_lab, charthick =charthick_lab
endif
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 3.00 and z_bin_boss_S82  lt 3.25 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
if (choice_DR9_points eq 'y') then begin
   ...
   if (choice_S82_points eq 'y') then begin
      w82 =  where(z_bin_boss_S82  gt 3.25 and z_bin_boss_S82  lt 3.50 and $
                   Mi_boss_S82  le max(Mi_boss[www]) and Mi_boss_S82  ge min(Mi_boss[www]), N_S82)
      plotsym, 0, plot_sym_size_S82, /fill
      Mi_boss_err_S82 = log_Phi_boss_S82[w82] - log_Phi_boss_S82[w82]
...
xpos = -32.10
ypos =  1.50  ;; to put it into the middle row...
yoff =  0.30
...
;legend, 'fiducial_tweak' , $
 ;       position=[xpos, ypos-(1*yoff)], box=0, psym=8, color=color_dr9, $
  ;      charsize=charsize, charthick =charthick

plotsym, plot_sym_fid, 1.5, /fill
;legend, 'fiducial' , $
 ;       position=[xpos, ypos-(2*yoff)], box=0, psym=8, color=color_dr9_fid, $
  ;         charsize=charsize, charthick =charthick

plotsym, plot_sym_exp, 1.5, /fill
;legend, 'exp_dust' , $
 ;       position=[xpos,  ypos-(3*yoff)], box=0, psym=8, color=color_dr9_exp, $
  ;         charsize=charsize, charthick =charthick
...
;; To match qlf_plot_iband_toz3pnt5.pro:
;charsize          4.00
;charthick       7.00

xyouts, -11.7, 0.40,  $
        'log!I10!N (!7U!3!I !N!3/!7U!3!Ifiducial!N!3)', $
;        'log!I10!N (!7U!3!Ialtern!N!3/!7U!3!Ifiducial!N!3)', $
;        'log!I10!N (!7U!3!Icalc!N!3/!7U!3!Ifiducial!N!3)', $
;        'log!I10!N !7U!3(M!Ii!N[z=2]) [Mpc!E-3!N mag!E-1!N]', $
        ORIENTATION=90, charsize=4.0, $
       charthick=7.0

xyouts, -20.5, -0.95,  $
        'M!Ii!N[z=2]', $
       charthick=7.0, charsize=4.0
