...
print
print, 'iMag_limit_line[5,0]  ', iMag_limit_line[5,0]  
print
...
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_wgt gt 2.20 and z_bin_boss_wgt lt 2.60 and $
               log_Phi_boss_wgt gt -50 and Mi_BOSS_wgt le -24.50, N) 
...
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_VdB gt 2.20 and z_bin_boss_VdB lt 2.60 and $
               log_Phi_boss_VdB gt -50 and Mi_BOSS_VdB le -24.5, N) 
...
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_Exp gt 2.20 and z_bin_boss_Exp lt 2.60 and $
               log_Phi_boss_Exp gt -50 and Mi_BOSS_Exp le -24.5, N) 
...
xyouts, x_xyouts+1.5, y_xyouts-(offset), '!82.20<z<2.60!3', charsize=2.6, charthick=8/1.2, color=black
