...
diff_up   =  ratio - alog10((10^(log_Phi_boss21[w] + boss21_delta_up[w21])) / divmodel)
diff_up   =  ratio - alog10((10^(log_Phi_boss21[w] + boss21_delta_down[w21])) / divmodel)
...
x_xyouts = -18.80   ;; -19.30
y_xyouts =  1.20 ;-0.50  ;; 1.00  ;;; or something aroudn -0.50???
y_off    = 0.15
offset   = 0.20
...
legend, '', position=[x_xyouts, y_xyouts-(1*offset)], box=0, psym=8, color=black, $
        charsize=charsize/1.4, charthick =charthick*1.2
xyouts, x_xyouts-1.2, y_xyouts-(1*offset)-y_off, 'SDSS', $
...
legend, '' , position=[x_xyouts, y_xyouts-(2*offset)], box=0, psym=8, color=color_2slaq, $
        charsize=charsize/1.4, charthick =charthick*1.2
xyouts, x_xyouts-1.2, y_xyouts-(2*offset)-y_off, '2SLAQ', $
...
legend, '', position=[x_xyouts, y_xyouts-(3*offset)], box=0, psym=8, color=blue, $
        charsize=charsize/1.4, charthick =charthick*1.2
xyouts, x_xyouts-1.2, y_xyouts-(3*offset)-y_off, 'boss21+MMT', $
