...
;      readcol, '../../pro/models/Croom09b_PLE_toz5.dat', $
      readcol, 'chi_sq_PLE_model_McG_2.2z3.5_temp.dat', $
...
;       position=[0.35, 0.70, 0.56, 0.98], $ ;; good for a 3x4 grid...
       position=[0.09, 0.56, 0.26, 0.96], $ ;; good for a 2x5 grid...
       xstyle=1, $
       ystyle=1, $
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
...
;       position=[0.56, 0.70, 0.77, 0.98], $
       position=[0.26, 0.56, 0.43, 0.96], $ ;; good for a 2x5 grid..
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
       /nodata, $
       xstyle=1,          ystyle=1, $
...
;       position=[0.77, 0.70, 0.98, 0.98], $
       position=[0.43, 0.56, 0.60, 0.96], $ ;; good for a 2x5 grid...
       xstyle=1, $
       ystyle=1, $
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
...
;       position=[0.14, 0.42, 0.35, 0.70], $
       position=[0.60, 0.56, 0.77, 0.96], $ ;; good for a 2x5 grid...
       xstyle=1, $
       ystyle=1, $
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
...
;       position=[0.35, 0.42, 0.56, 0.70], $   ;; for 3 x 4 panels...
       ...
       position=[0.77, 0.56, 0.94, 0.96], $ ;; good for a 2x5 grid...
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
       xthick=xthick, ythick=ythick, $
       xstyle=1,      ystyle=1, $
...
;       position=[0.56, 0.42, 0.77, 0.70], $ ;; good for a 3x4 grid..
       position=[0.09, 0.16, 0.26, 0.56], $ ;; good for a 2x5 grid...
       xstyle=1, ystyle=1, $
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
       /nodata, $
...
;       position=[0.77, 0.42, 0.98, 0.70], $
       position=[0.26, 0.16, 0.43, 0.56], $ ;; good for a 2x5 grid...
...
;       position=[0.14, 0.14, 0.35, 0.42], $
       position=[0.43, 0.16, 0.60, 0.56], $ ;; good for a 2x5 grid...
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
       xthick=xthick, ythick=ythick, $
       xstyle=1,      ystyle=1, $
...
;       position=[0.35, 0.14, 0.56, 0.42], $
       position=[0.60, 0.16, 0.77, 0.56], $ ;; good for a 2x5 grid...
       xstyle=1, ystyle=1, $
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
       xthick=xthick, ythick=ythick, $
...
;       position=[0.56, 0.14, 0.77, 0.42], $
       position=[0.77, 0.16, 0.94, 0.56], $ ;; good for a 2x5 grid...
       xstyle=1, $
       ystyle=1, $
       xrange=[x_min, x_max], $
       yrange=[y_min, y_max], $
...
if (choice_BOSS_points eq 'y') then begin
   if (choice_DR9_points eq 'y') then begin
      ...
      legend, 'BOSS QSOs DR9' , $
              ...
              position=[-31.00, -5.70], box=0, psym=8, color=color_dr9, $
              charsize=charsize*factor, charthick =charthick*(factor^2)
      xyouts, -31.20, -6.60,'(color-selected)',  color=color_dr9, $
              charsize=charsize*factor, charthick =charthick*(factor^2)
   endif
   ...
   if (choice_S82_points eq 'y') then begin
      ...
      legend, 'BOSS QSOs S82' , $
              ...
              charsize=charsize*factor, charthick =charthick*(factor^2)
          xyouts, -31.20, -7.90,'(variability-selected)',  color=color_S82, $
              charsize=charsize*factor, charthick =charthick*(factor^2)
   endif
...
;           xyouts, -31.50, -8.40,'expdust_grid', $
 ;         color=color_dr9, charsize=charsize*1.4, charthick =charthick*1.4
   ...
   legend, ' ' , $
           position=[-31.00, -8.20], box=0, linestyle=0, color=color_dr9, $
           charsize=1.1, charthick =12., thick= 16.0
;xyouts, -31.20, -9.0,'i!9A!321.8 limit', $
   xyouts, -34.00, -8.50,'2.2<z<2.3 data', $
