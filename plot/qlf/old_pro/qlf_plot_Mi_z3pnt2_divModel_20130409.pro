...
;Mi_C17 = M145_C17   - 0.29 most likely wrong...
;Mi_C17 = MBband_C17 - 0.71
;Mi_C17 = M145_C17   + 0.29 most likely wrong...
Mi_C17 = M145_C17 + 0.714
...
;; SWIRE 1450A actually in AB..
;Miz2 = M145_C17 + 0.714
;Mi_SWIRE =  M145_SWIRE - 0.29 ;; old correction..
;; M_i(z=2) = M_AB1450 - 1.486 = M_Vega1450 + 2.2 - 1.486 = M_Vega1450 + 0.714
Mi_SWIRE =  M145_SWIRE - 1.486 ;; old correction..
...
;Mi_COSMOS = M145_COSMOS - 0.29  ;;old and wrong...
Mi_COSMOS = M145_COSMOS - 1.486  ;;old and wrong...
;; M_i(z=2) = M_AB1450 - 1.486 = M_Vega1450 + 2.2 - 1.486 = M_Vega1450 + 0.714
Mi_COSMOS = M145_COSMOS - 1.486 
...
;divmodel = best_fit_PLE(3.20, Mi_swire)
divmodel  = best_fit_linear_Phi(3.20, Mi_swire)
...
;divmodel = best_fit_PLE(3.20, Mi_COSMOS)
divmodel  = best_fit_linear_Phi(3.20, Mi_COSMOS)
...
oplot, Mi_C17, log_phi_C17, psym=8, color = c17_clr

;divmodel = Hopkins_full_mag(3.20, Mi_C17)
;divmodel  = best_fit_PLE(3.20, Mi_C17)
divmodel  =  best_fit_linear_Phi(3.20, Mi_C17) 

log_divmodel = alog10(divmodel)

PLOTSYM, c17_sym, 3.4, /fill
if choice_how2plot eq '1' then oplot, Mi_C17, (log_phi_C17/log_divmodel), psym=8, color = clr_c17
if choice_how2plot eq '2' then oplot, Mi_C17,  alog10((10^log_Phi_C17) /divmodel), psym=8, color = c17_clr

ratio  =  alog10((10^log_Phi_C17) /divmodel)
;diff   =  ratio - alog10((10^(log_Phi_C17[w] + sigma_C17)) / divmodel)
diff   =  ratio - alog10((10^(log_Phi_C17 + sigma_C17)) / divmodel)
...
;op;loterror, Mi_C17, ratio, Mi_C17_err, diff, $
