...
;   oplot, Mi_boss[www], alog10((10^log_Phi_boss[www])/divmodel), psym=3, color=color_dr9, thick=12
...
charsize_lab  = charsize/2.3
loadct, 0

xpos = -24.15
ypos =  0.740     ;; -0.42 was for the bottom-right hand corner...
y_off = 0.12
