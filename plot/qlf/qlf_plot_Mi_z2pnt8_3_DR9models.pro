...
set_plot, 'ps'
!p.multi=0
device, filename='QLF_Mi_z2pnt8_3_DR9models_temp.ps', $
        xsize=8.0, ysize=8.0, $
...
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_wgt gt 2.60 and z_bin_boss_wgt lt 3.00 and $
...
;   www = where(z_bin_boss gt 3.00 and z_bin_boss lt 3.50 and $
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_VdB gt 2.60 and z_bin_boss_VdB lt 3.00 and $
               log_Phi_boss_VdB gt -50 and Mi_BOSS_VdB le -25.0, N) 
...
;   www = where(z_bin_boss gt 3.00 and z_bin_boss lt 3.50 and $
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_Exp gt 2.60 and z_bin_boss_Exp lt 3.00 and $
               log_Phi_boss_Exp gt -50 and Mi_BOSS_Exp le -25.0, N) 
...
xyouts, x_xyouts+1.5, y_xyouts-(offset), '!82.60<z<3.00!3', charsize=2.6, charthick=8/1.2, color=black
