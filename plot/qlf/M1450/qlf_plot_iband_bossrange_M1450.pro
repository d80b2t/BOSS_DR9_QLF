;+
; NAME:
;   qlf_plot_iband_bossrange_M1450
; 
; PURPOSE:
...
;
; CALLING SEQUENCE:
;       .run qlf_plot_iband_bossrange_M1450
;
; INPUTS:
...
;; Key Line, Fix for M_1450..., 
Abs_mag_bin_dr3 = Abs_mag_bin_dr3 + 1.486
...
;; Key Line, Fix for M_1450...
Abs_mag_bin_boss_s82 = Abs_mag_bin_boss_s82 + 1.486
...
;; Key Line, Fix for M_1450...
Abs_mag_bin_boss_bin1 = Abs_mag_bin_boss_bin1 + 1.486
...
;; Key Line, Fix for M_1450...
Abs_mag_bin_boss = Abs_mag_bin_boss + 1.486
...
;; Key Line, Fix for M_1450...
Abs_iMag_limit = Abs_iMag_limit + 1.486
...
set_plot, 'ps'
!p.multi=[0,3,4]
device, filename='QLF_iband_R06_z2_narrowZ_M1450_temp.ps', $
