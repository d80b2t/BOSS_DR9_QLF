...
print
print
Mi2_offset = 1.486   ;; R06 Eq. 3, by default
read,  Mi2_offset, PROMPT=' - Value of  Mi2_offset??   '
print
...
;M_BOSS = Abs_mag_bin_boss - 0.98
M_BOSS = Abs_mag_bin_boss + Mi2_offset
...
;M_BOSS_wgt = Abs_mag_bin_boss_wgt + 1.486
;M_BOSS_wgt = Abs_mag_bin_boss_wgt - 0.98
M_BOSS_wgt = Abs_mag_bin_boss_wgt + Mi2_offset
...
;M_S82 = Abs_mag_bin_boss_S82 - 0.98
M_S82 = Abs_mag_bin_boss_S82 + Mi2_offset
...
;;    R01, Table 3: z=3.20 (g-r)=0.217 and (r-i)=0.104 
;;    ==> (g-i) = 0.321

Mi_MMT = Mg_MMT - 0.321
;M_MMT  = Mi_MMT + 1.486
;M_MMT  = Mi_MMT - 0.98
M_MMT  = Mi_MMT + Mi2_offset
...
readcol, 'SWIRE_Siana2008_z3pnt2.dat', $
         M_SWIRE, phi_SWIRE, phi_swire_up, phi_swire_down
...
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss gt 3.00 and z_bin_boss lt 3.50 and $
               log_Phi_boss gt -500 and Abs_mag_bin_boss le -25.0, N) 
...
M_swire_err =  M_swire -  M_swire
oploterror, M_swire, log_Phi_swire, M_swire_err, err_swire_up,  $
            /hibar, errthick=12, psym=8, color=green, ERRcolor=green
oploterror, M_swire, log_Phi_swire, M_swire_err, err_swire_down, $
