...
!p.multi=0
device, filename='QLF_M1450_evolution_temp.ps', $
        xsize=8.0, ysize=8.0, $
...
;;   2 S L A Q    Q S Os
;; 
w = where(z_2SLAQ ge 0.4 and z_2SLAQ lt 0.6, N)

;; Assuming (g-r)= -0.1 and (r-i)=0.15  at z~0.5 
...
;oplot,       M_SDSS[w], log_PhiR06[w], psym=8, color=purple
;oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_up[w],   /hibar, errthick=12, psym=8, color=purple, ERRcolor=purple
;oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_down[w], /lobar, errthick=12, psym=8, color=purple, ERRcolor=purple
...
w21 =  where(z_bin_boss21 gt 1.06 and z_bin_boss21 lt 1.44 and M_boss21 le M_limit[0], N)

M_boss21_err = M_boss21[w21] - M_boss21[w21]

;oplot, M_boss21[w21], log_Phi_BOSS21, color=purple, ps=8
;oploterror, M_boss21[w21], log_Phi_BOSS21[w21], Mi_boss_err, $
 ;           boss21_delta_up[w21], /hibar, errthick=12, psym=8, color=purple, ERRcolor=purple
;oploterror, M_boss21[w21], log_Phi_BOSS21[w21], Mi_boss_err, $
 ;           boss21_delta_down[w21], /lobar, errthick=12, psym=8, color=purple, ERRcolor=purple
;endif
...
plotsym, 8, plot_sym_size_R06/2., /fill
;oplot,  M_SDSS[w], log_PhiR06[w], psym=8
M_SDSS_err = M_SDSS[w] -M_SDSS[w]
oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_up[w],   /hibar, errthick=12, psym=8, color=red, ERRcolor=red
oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_down[w], /lobar, errthick=12, psym=8, color=red, ERRcolor=red
...
plotsym, sym_2slaq, plot_sym_size_R06, /fill
;M_2SLAQ_err = M_2SLAQ[w] - M_2SLAQ[w]
oplot,       M_2SLAQ[w], log_phi_2SLAQ[w], psym=8, color=red
...
PLOTSYM, 0, 1.4, /fill
w  =  where(z_R06 gt 3.00 and z_R06 lt 3.50 and M_SDSS le -27.74) 
oplot,  M_SDSS[w], log_PhiR06[w], psym=8,  color = blue

plotsym, 8, plot_sym_size_R06, /fill
oplot,  M_SDSS[w], log_PhiR06[w], psym=8
M_SDSS_err = M_SDSS[w] - M_SDSS[w]
oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_up[w],   /hibar, errthick=12, psym=8, color=blue, ERRcolor=blue
oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_down[w], /lobar, errthick=12, psym=8, color=blue, ERRcolor=blue

;;
;; SWIRE points (from Siana et al. 2008)
;;    (trying for green SWIRE squares...)
PLOTSYM, 0, 1.2, /fill
oplot, M_swire, log_phi_swire, psym=8,  color = blue
...
;;
cosmos_sym = 5
PLOTSYM, cosmos_sym, 1.8, /fill
oplot, M_cosmos, log_phi_cosmos_3pnt2, psym=8,  color = blue
 M_COSMOS_err = M_cosmos - M_cosmos
oploterror, M_cosmos, log_phi_cosmos_3pnt2, M_COSMOS_err, $
            COSMOS_3PNT2_DELTA_UP,   /hibar, errthick=12, psym=8, color=blue, ERRcolor=blue
oploterror, M_cosmos, log_phi_cosmos_3pnt2, M_COSMOS_err, $
            COSMOS_3PNT2_DELTA_down, /lobar, errthick=12, psym=8, color=blue, ERRcolor=blue
...
;   www = where(z_bin_boss gt 3.00 and z_bin_boss lt 3.50 and $
;               M_BOSS lt iMag_limit_line[7,0] and log_Phi_boss gt -500, N) 
   www = where(z_bin_boss_wgt gt 3.00 and z_bin_boss_wgt lt 3.50 and log_Phi_boss_wgt gt -50 and M_BOSS_wgt le M_limit[2], N) 
   
   oplot, M_BOSS_wgt[www], log_Phi_boss_wgt[www], psym=8, color=blue
...
oplot,  M_SDSS[w], log_PhiR06[w], psym=8,  color = green

plotsym, 8, plot_sym_size_R06, /fill
oplot,  M_SDSS[w], log_PhiR06[w], psym=8
M_SDSS_err = M_SDSS[w] - M_SDSS[w]
oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_up[w],   /hibar, errthick=12, psym=8, color=green, ERRcolor=green
oploterror, M_SDSS[w], log_PhiR06[w], M_SDSS_err, R06_delta_down[w], /lobar, errthick=12, psym=8, color=green, ERRcolor=green

;;
;; COSMOS  z~4  points (from Masters et al. 1207.2154v1)
;;
PLOTSYM, 1, 1.4, /fill
oplot, M_cosmos, log_phi_cosmos_4, psym=8,  color = green
...
xyouts, x_xyouts, y_xyouts+(2*offset), '!8z~2.4!3', charsize=2.4, charthick=6, color=red
...
;loadct, 6
plotsym, 0, 1.0, /fill
legend, 'BOSS' , position=[x_xyouts, y_xyouts], box=0, psym=8, color=black, charsize=charsize*1.2, charthick =charthick*1.2

plotsym, 8, plot_sym_size_R06, /fill
legend, 'SDSS' , position=[x_xyouts, y_xyouts-offset], box=0, psym=8, color=black, charsize=charsize*1.2, charthick =charthick*1.2
plotsym, sym_2slaq, plot_sym_size_R06, /fill
legend, '2SLAQ' , position=[x_xyouts, y_xyouts-(2*offset)], box=0, psym=8, color=black, charsize=charsize*1.2, charthick =charthick*1.2
...
log_phi_fit    = alog10(phi_fit)
loadct, 13
;oplot, mag_fit, log_Phi_fit,    thick=thick*2.2, color=green
...
if (choice_models_HRH07 eq 'y') then begin
   ...
   oplot, ABMag_HRH07, alog10(phi_HRH07_z2pnt4)-per_mag, thick=8, linestyle=0, color=red
...
;xyouts, -2.5, -7.5, 'log!I10!N !7U!3(M!Ii!N[z=2]) [Mpc!E-3!N mag!E-1!N]', $
;        ORIENTATION=90, charsize=charsize, charthick=charthick*1.8
...
legend, 'SDSS QSOs' , $
        ...
        charsize=charsize*1.6, charthick=charthick*1.8

xyouts, -31.20, -7.00,'(Richards+ 2006)',  $
        color=0, charsize=charsize, charthick =charthick
...
if (choice_BOSS_points eq 'y') then begin
   ...
   plotsym, 0, 1.5, /fill
   legend, 'BOSS QSOs' , $
;        position=[-31.00, -7.50], box=0, psym=8, color=boss_color, $
           position=[-31.00, -7.25], box=0, psym=8, color=boss_color, $
           charsize=charsize*1.6, charthick =charthick*1.8
   
   legend, ' ' , $
           position=[-31.00, -8.10], box=0, linestyle=1, color=boss_color, $
           charsize=1.5, charthick =12., thick= 16.0
;xyouts, -31.20, -9.0,'i!9A!321.8 limit', $
   xyouts, -31.20, -9.0,'i=21.8 limit', $
        color=boss_color, charsize=charsize*1.4, charthick =charthick*1.4
