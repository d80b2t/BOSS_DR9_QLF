...
set_plot, 'ps'
!p.multi=0
device, filename='QLF_M1450_z2pnt0_temp.ps', $
        xsize=8.0, ysize=8.0, $
...
;if (choice_BOSS21_points eq 'y') then begin
   ...
   oplot, M_boss21[w21], log_Num_den_boss21[w21], color=boss21_color, ps=8

   M_boss21_err = log_Num_den_boss21[w21] - log_Num_den_boss21[w21]
   oploterror, M_boss21[w21], log_Num_den_boss21[w21], M_boss21_err, $
               boss21_delta_up[w21], /hibar, errthick=12, psym=8, color=boss_color, ERRcolor=boss_color
   oploterror, M_boss21[w21], log_Num_den_boss21[w21], Mi_boss_err, $
...
;;
if (choice_models_HRH07 eq 'y') then begin
   readcol, '/cos_pc19a_npr/BOSS/QLF/pro/models/HRH07/HRH07_1450A_z2.0.dat', $
