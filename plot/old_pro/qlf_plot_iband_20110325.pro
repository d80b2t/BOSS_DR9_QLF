...
oplot, Abs_Mag_bin_boss[www], log_Num_den_boss[www], psym=8, color=160
plotsym, 0, plot_sym_size_BOSS, /fill 
www =  where(z_bin_boss gt 4.00 and z_bin_boss lt 4.50 and Abs_mag_bin_boss lt iMag_limit_line[9,0]) 
oplot, Abs_Mag_bin_boss[www], log_Num_den_boss[www], psym=8, color=160
...
xyouts, -31.20, -6.80,'(Richards+ 2006)',  color=0, charsize=charsize, charthick =charthick
