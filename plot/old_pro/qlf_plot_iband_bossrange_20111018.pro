...
loadct, 6
;; Want to oplot the BOSS 2.10<z<2.20 line
...
;   www =  where(z_bin_boss_bin1 gt 2.20 and z_bin_boss_bin1 lt 2.60 $
 ;               and Abs_mag_bin_boss_bin1 lt -24.5 and RAW_N_BOSS_QSOS_bin1 gt 0, N) 
