...
;readcol, '../pro/qlf/My_QLF_iband_boss_S82_stnd.dat', $ ;; USE THIS FOR THE S82 plots!!!
 ;        z_bin_boss, Abs_mag_bin_boss, blah_boss,log_Num_den_boss, raw_N_QSOs_boss
...
readcol, '../pro/qlf/My_QLF_iband_boss21_wSelfn_20120305.dat', $  ;; USE THIS FOR THE boss21 chunk!!
...
;     oplot, Abs_Mag_bin_boss[www],     log_Num_den_boss[www],     color=boss_color, thick=6
   ...
   if (choice_S82_points eq 'y') then begin
      ...
      xyouts, x_xyouts-1.0, y_xyouts-3.1, '!8z=2.4', charsize=2.2, charthick=8., color=60.
...
if (choice_BOSS21_points eq 'y') then begin
   ...
   ;; Actually doesn't really add much... 
   ;oplot, Abs_Mag_bin_boss21[w21], log_Num_den_boss21[w21], color=boss21_color, ps=8
   ;Mi_boss_err = log_Num_den_boss21[w21] - log_Num_den_boss21[w21]
   ;oploterror, Abs_Mag_bin_boss21[w21], log_Num_den_boss21[w21], Mi_boss_err, $
   ;            boss21_delta_up[w21], /hibar, errthick=12, psym=8, color=boss21_color, ERRcolor=boss21_color
...
plotsym, 0, plot_sym_size_BOSS, /fill
if (choice_DR9_points eq 'y') then begin
   www =  where(z_bin_boss gt 2.60 and z_bin_boss lt 3.00 and Abs_mag_bin_boss lt -24.5 and log_Phi_boss gt -500, N) 
   oplot, Abs_Mag_bin_boss_wgt[www], log_Num_den_boss_wgt[www], psym=8, color=boss_color
   ;oplot, Abs_Mag_bin_boss_wgt[www], log_Num_den_boss_wgt[www], color=boss_color, thick=12
...
if (choice_DR9_points eq 'y') then begin
   www = where(z_bin_boss gt 3.50 and z_bin_boss lt 4.00 and $
               Abs_mag_bin_boss lt iMag_limit_line[8,0] and log_Phi_boss gt -500, N) 
   ...
   ;; 2.20<z<2.60 line and the BOSS mag-limit...
   www =  where(z_bin_boss gt 2.20 and z_bin_boss lt 2.60 and Abs_mag_bin_boss lt -24.5, N) 
   oplot, Abs_Mag_bin_boss_wgt[www], log_Num_den_boss_wgt[www], color=boss_color, thick=12
endif
...
if (choice_S82_points eq 'y') then begin
   www =  where(z_bin_boss_S82  gt 3.50 and z_bin_boss_S82  lt 4.00 and $
                Abs_mag_bin_boss_S82  lt iMag_limit_line[8,0] and RAW_N_BOSS_QSOS_S82  gt 0, N )
   oplot, Abs_Mag_bin_boss_S82[www], log_Num_den_boss_S82[www], psym=8, color=s82_color
...
plotsym, 0, plot_sym_size_BOSS, /fill 
if (choice_DR9_points eq 'y') then begin
   www =  where(z_bin_boss gt 4.00 and z_bin_boss lt 4.50 and $
                Abs_mag_bin_boss lt iMag_limit_line[9,0] and log_Phi_boss gt -500,N) 

   if N gt 0 then begin
      oplot, Abs_Mag_bin_boss[www], log_Num_den_boss[www], color=boss_color, thick=12
      oplot, Abs_Mag_bin_boss[www], log_Num_den_boss[www], psym=8, color=boss_color   
      if (choice_DR9_errorbars eq 'y' and N gt 0) then begin
         Mi_boss_err = log_Num_den_boss[www] - log_Num_den_boss[www]
         oploterror, Abs_Mag_bin_boss[www], log_Phi_boss[www], Mi_boss_err, boss_delta_up[www],  $
                     /hibar, errthick=12, psym=8, color=boss_color, ERRcolor=boss_color
         oploterror, Abs_Mag_bin_boss[www], log_Phi_boss[www], Mi_boss_err, boss_delta_down[www], $
...
plotsym, 0, plot_sym_size_S82, /fill
if (choice_S82_points eq 'y') then begin
   www =  where(z_bin_boss_S82  gt 4.00 and z_bin_boss_S82  lt 4.50 and $
                Abs_mag_bin_boss_S82  lt -24.5 and RAW_N_BOSS_QSOS_S82  gt 0, N )
   oplot, Abs_Mag_bin_boss_S82[www], log_Num_den_boss_S82[www], psym=8, color=s82_color
...
if (choice_BOSS21_points eq 'y') then begin
   loadct, 6
   plotsym, 0, 1.5, /fill
   w21 =  where(z_bin_boss21 gt 4.00 and z_bin_boss21 lt 4.50 and RAW_N_QSOS_boss21 gt 0, N )
   ;; Really adds v. v. little...
   ;;oplot, Abs_Mag_bin_boss21[w21], log_Num_den_boss21[w21], color=boss21_color, ps=8
endif
...
plotsym, 0, plot_sym_size_BOSS, /fill 
if (choice_DR9_points eq 'y') then begin
   www =  where(z_bin_boss gt 4.50 and z_bin_boss lt 5.00 and $
                Abs_mag_bin_boss lt iMag_limit_line[10,0] and log_Phi_boss gt -500, N)
...
plotsym, 0, plot_sym_size_S82, /fill
if (choice_S82_points eq 'y') then begin
   www =  where(z_bin_boss_S82  gt 4.50 and z_bin_boss_S82  lt 5.00 and $
                Abs_mag_bin_boss_S82  lt iMag_limit_line[10,0] and RAW_N_BOSS_QSOS_S82  gt 0, N )
   oplot, Abs_Mag_bin_boss_S82[www], log_Num_den_boss_S82[www], psym=8, color=s82_color
