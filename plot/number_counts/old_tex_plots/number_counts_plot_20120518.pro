...
;oploterror, SDSS_N_i, SDSS_N_ierr, /hibar, errthick=12, psym=8, color=boss_color, ERRcolor=boss_color
;oploterror, SDSS_N_i, SDSS_N_ierr, /lobar, errthick=12, psym=8, color=boss_color, ERRcolor=boss_color
oploterror, SDSS_mag, SDSS_N_i, SDSS_mag_xerr, SDSS_N_ierr, /hibar, errthick=errthick, psym=2, color=sdss_color, ERRcolor=sdss_color
oploterror, SDSS_mag, SDSS_N_i, SDSS_mag_xerr, SDSS_N_ierr, /lobar, errthick=errthick, psym=2, color=sdss_color, ERRcolor=sdss_color
...
;;
;;plot,  BOSS_imag, BOSS_S82_nm*(1./0.25),   ps=3, /ylog
...
;; PL label first
xyouts, 15.1, 5., 'N(i)!9?!3i!U0.94!N', charthick=4.2, charsize=2.6
...
plotsym, 0, 1, /fill
legend, [' '], pos=[19.0, below_btm_leg],  box=0, psym=8, color=red
legend, [' '], pos=[19.0, below_btmm_leg], box=0, psym=1, color=red
...
xyouts, 19.6, below_btm, ' "  w/ correction', charsize=charsize, charthick=charthick, color=red
xyouts, 19.6, below_btmm, 'Stp82 2.2<z<3.5', charsize=charsize, charthick=charthick, color=red
...
;;
plotsym, 0, 1
oplot,  BOSS_imag, BOSS_N_DR9_nm_sum, ps=8, color=red
...
;;  B O S S    S T R I P E   8 2
;;
oplot,      BOSS_imag, BOSS_N_S82_nm_sum, ps=1, color=red
...
;;
plotsym, 0, 1,/fill
oplot,  BOSS_imag, BOSS_BOSS21_NM_SUM,  ps=8,  color=blue
w = where(BOSS_boss21_nm_sum_err gt 0, N)
